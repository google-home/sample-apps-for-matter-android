...
/**
 * The Inspect Screen shows all the "cluster" information about the currently
 * selected device in the Device screen.
 */
@Composable
fun InspectRoute(
...
private fun InspectScreenLoadingPreview() {
  MaterialTheme {
    InspectScreen(PaddingValues(),null, null, {})
  }
}
...
private fun InspectScreenOfflinePreview() {
  MaterialTheme {
    InspectScreen(PaddingValues(), emptyList(), null, {})
  }
}
