 ...
 * same network as the app. The SETUP_CODE below should match with the set up code of the Matter
 * device. 2) You only have one Home structure in the Google home app.
 */
